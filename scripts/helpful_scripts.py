...
def get_contract(contract_name):
    """This function will grab the contract address from the brownie config if defined, otherwise, it will deploy a
...
def deploy_mocks(decimal=DECIMAL, initial_value=INITIAL_VALUE):
    account = get_account()
